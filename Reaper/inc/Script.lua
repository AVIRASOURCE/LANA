...
return '☎️*┇*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(max..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
if not msg.SudoUser then return "👨🏻‍💻*┇* لـلـمـطـور فـقـط" end
return '⏺️*┊*عدد المشتركين في البوت : `'..redis:scard(max..'users')..'` \n📡'
end
...
return '🛡┊ REAPER VERSION : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "👨🏻‍💻*┇* لـلـمـطـور الاسـاسـي فـقـط" end
local GetVerison = https.request('https://github.com/SHADOTEAM/shad.github.io/GetVersion.txt') or 0
...
elseif Text== "😔"  then return sendMsg(msg.chat_id_,msg.id_,"لـﮩـضـوج פـٍـٍبيبي")
elseif Text== "☹️"  then return sendMsg(msg.chat_id_,msg.id_,"لـﮩـضـوج פـٍـٍبيبي")
