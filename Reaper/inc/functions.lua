...
.."\n*➕┇*عدد التكرار ⇜ "..(redis:get(max..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*🏌🏻‍♂️┇*`اعدادات التقـييد :`\n"
.."\n*💢┇*التقيد بالتوجيه ⇜ "..(redis:get(max..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸┇*التقيد بالصور ⇜ "..(redis:get(max..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗┇*التقيد بالروابط ⇜ "..(redis:get(max..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉┇*التقيد بالمتحركه ⇜ "..(redis:get(max..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥┇*التقيد الفيديو ⇜ "..(redis:get(max..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❪ مقفول ❫')
list_settings = list_settings:gsub('false', '❪ مفتوح ❫')
